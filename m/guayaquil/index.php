...
<html> 
	<head>
		...
		<link rel="canonical" href="http://www.guiaa.com">
...
<meta name="mobile-web-app-capable" content="yes">
	...
	<div id="mySidenav" class="sidenav">
		...
		<a href="../">Inicio</a>
		<a href="../anadirlugares?loc=<?php echo"$Loc";?>">Añadir un lugar</a>
		<a href="../anadireventos?loc=<?php echo"$Loc";?>">Añadir un evento</a>
		<a href="../nosotros?loc=<?php echo"$Loc";?>">Nosotros</a>
		<a href="../contacto?loc=<?php echo"$Loc";?>">Contactanos</a>
		<a href="../ciudades?loc=<?php echo"$Loc";?>">Ciudades</a>
	</div>
