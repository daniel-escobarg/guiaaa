	...
	<body> 
		...
		<div class="city-tiles">
			...
			while($row = mysql_fetch_array($result)) 
				{echo "<td> <a href='../../".$row{'directory'}."?loc=$Loc'><div class='tile' style='background-color:".$row{'color'}."'><center> <h1> ".$row{'name'}." </h1> </center> </a></td>";}?>
					</tr>
					<tr>
		...
		<div class="mp-eventarea">
			...
			<?php
				...
				<a href='../../evento/?id=".$row{'id_evento'}."'> 
					<div class='mp-event-results-logo' style='background: white url(".$row{'poster_url'}.") no-repeat center; background-size: 18vw;'>
					</div> 
				</a>
				<br>
				<div class='mp-event-results-title'>
					<b> <a href='../../evento/?id=".$row{'id_evento'}."'>".$row{'nombre'}."  </a> </b>
					<i> <a href='../../evento/?id=".$row{'id_evento'}."'>".$row{'categoria'}."</a> </i>
					<br>					
					
					<a href='../../evento/?id=".$row{'id_evento'}."'>".$row{'fecha_i'}." ".$row{'hora_inicio_i'}."</a> &middot; <a href='../../evento/?id=".$row{'id_evento'}."'>".$row{'costo'}."</a>
					<br>
					<a href='../../biz/?id=".$row{'id_establecimiento'}."'>".$row{'nombre_lugar'}."</a>
				</div>
				</td>";}
					?> 
