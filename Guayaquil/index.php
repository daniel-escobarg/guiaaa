...
<head>
		...
		<title> <?php echo"$page_name";?> - Restaurantes, Tiendas, Bares y más. </title>
	...
	<body> 
		...
		<div class="webtitle"><a href="../"><?php echo"$site_name $page_name";?></a> </div>
		<h1> Encuentra lugares en <?php echo"$Loc";?> </h1>
		...
		<h1> Encuentra restaurantes en <?php echo"$Loc";?></h1>
		...
		<div class="webtitle"><a style="color:white" href="../"><?php echo"$site_name $page_name";?></a> </div>
		<h1> Encuentra la vida nocturna en <?php echo"$Loc";?></h1>
		...
		<div class="webtitle"><a style="color:white" href="../"><?php echo"$site_name $page_name";?></a> </div>
		<h1> Salud </h1>
		<p> ¿Farmacias, doctores, laboratorios?  — todo en un lugar.</p>
		<a id="mp-bttn-white" href="../salud?loc=<?php echo"$Loc";?>">Salud</a> 
		</div>
